...
- [CaviraOSS/PageLM](https://github.com/CaviraOSS/PageLM) (4 days ago) - PageLM is a community driven version of NotebookLM &amp; a education platform that transforms study materials into interactive resources like quizzes, flashcards, notes, and podcasts.
- [lycheeverse/lychee](https://github.com/lycheeverse/lychee) (4 days ago) - ⚡ Fast, async, stream-based link checker written in Rust. Finds broken URLs and mail addresses inside Markdown, HTML, reStructuredText, websites and more!
- [hedgetechllc/libopusenc-rs](https://github.com/hedgetechllc/libopusenc-rs) (5 days ago) - Safe Rust library to interact with the reference Opus Encoder (libopusenc)
