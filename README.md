...
- [ocornut/imgui](https://github.com/ocornut/imgui) (2 days ago) - Dear ImGui: Bloat-free Graphical User interface for C&#43;&#43; with minimal dependencies
- [juhaku/utoipa](https://github.com/juhaku/utoipa) (2 days ago) - Simple, Fast, Code first and Compile time generated OpenAPI documentation for Rust
- [gvergnaud/ts-pattern](https://github.com/gvergnaud/ts-pattern) (3 days ago) - 🎨 The exhaustive Pattern Matching library for TypeScript, with smart type inference.
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) (4 days ago) - CockroachDB — the cloud native, distributed SQL database designed for high availability, effortless scale, and control over data placement.
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (4 days ago) - A powerful little TUI framework 🏗
