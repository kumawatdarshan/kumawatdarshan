...
- [karl-cta/jobctrl](https://github.com/karl-cta/jobctrl) (1 day ago) - Self-hosted job application tracker. Single Go binary, SQLite database, zero cloud dependencies.
- [olive-language/olive](https://github.com/olive-language/olive) (1 day ago) - The Dream Programming Language
- [ereinaimer/taurine](https://github.com/ereinaimer/taurine) (1 day ago) - Fast, secure and easy to use text expander and keyboard automation tool
- [f-o-o-g-s/nokkvi](https://github.com/f-o-o-g-s/nokkvi) (2 days ago) - A rust based navidrome client for linux built using iced-rs
- [nektos/act](https://github.com/nektos/act) (1 week ago) - Run your GitHub Actions locally 🚀
