...
- [tanu1337/qwen-api](https://github.com/tanu1337/qwen-api) (1 day ago) - Qwen API RCE.
- [facebookexperimental/rust-shed](https://github.com/facebookexperimental/rust-shed) (1 day ago) - Repository containing Rust crates common between other Facebook open source projects (like Mononoke or Eden).
- [nik-rev/displaystr](https://github.com/nik-rev/displaystr) (5 days ago) - Ergonomically implement the `Display` trait
