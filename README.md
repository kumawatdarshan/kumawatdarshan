...
- [ibraheemdev/matchit](https://github.com/ibraheemdev/matchit) (3 days ago) - A high performance, zero-copy URL router.
- [Uni-Gal/Ayaka](https://github.com/Uni-Gal/Ayaka) (4 days ago) - A visual novel engine written in Rust. Just Ayaka.
- [ZacharyHampton/HomeHarvest](https://github.com/ZacharyHampton/HomeHarvest) (5 days ago) - Python package for scraping real estate property data
- [Vigintillionn/niri-sidebar](https://github.com/Vigintillionn/niri-sidebar) (5 days ago) - A lightweight, external sidebar manager for the Niri window manager.
- [DeterminateSystems/determinate](https://github.com/DeterminateSystems/determinate) (5 days ago) - Determinate is Nix for the enterprise. An end-to-end experience of using Nix, from installation to collaboration to deployment.
