...
- [serde-rs/serde](https://github.com/serde-rs/serde) (2 days ago) - Serialization framework for Rust
- [toon-format/toon](https://github.com/toon-format/toon) (2 days ago) - 🎒 Token-Oriented Object Notation (TOON) – Compact, human-readable, schema-aware JSON for LLM prompts. Spec, benchmarks, TypeScript SDK.
- [Snapchat/Valdi](https://github.com/Snapchat/Valdi) (2 days ago) - Valdi is a cross-platform UI framework that delivers native performance without sacrificing developer velocity.
...
- [Peternator7/strum](https://github.com/Peternator7/strum) (3 days ago) - A small rust library for adding custom derives to enums
