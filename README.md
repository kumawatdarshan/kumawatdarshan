...
- [anuvyklack/helheim-emacs](https://github.com/anuvyklack/helheim-emacs) (1 day ago) - 
- [ocornut/imgui](https://github.com/ocornut/imgui) (4 days ago) - Dear ImGui: Bloat-free Graphical User interface for C&#43;&#43; with minimal dependencies
- [juhaku/utoipa](https://github.com/juhaku/utoipa) (4 days ago) - Simple, Fast, Code first and Compile time generated OpenAPI documentation for Rust
- [gvergnaud/ts-pattern](https://github.com/gvergnaud/ts-pattern) (5 days ago) - 🎨 The exhaustive Pattern Matching library for TypeScript, with smart type inference.
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) (6 days ago) - CockroachDB — the cloud native, distributed SQL database designed for high availability, effortless scale, and control over data placement.
