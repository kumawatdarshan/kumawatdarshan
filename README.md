...
- [ocornut/imgui](https://github.com/ocornut/imgui) (3 days ago) - Dear ImGui: Bloat-free Graphical User interface for C&#43;&#43; with minimal dependencies
- [juhaku/utoipa](https://github.com/juhaku/utoipa) (3 days ago) - Simple, Fast, Code first and Compile time generated OpenAPI documentation for Rust
- [gvergnaud/ts-pattern](https://github.com/gvergnaud/ts-pattern) (4 days ago) - 🎨 The exhaustive Pattern Matching library for TypeScript, with smart type inference.
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) (5 days ago) - CockroachDB — the cloud native, distributed SQL database designed for high availability, effortless scale, and control over data placement.
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (5 days ago) - A powerful little TUI framework 🏗
